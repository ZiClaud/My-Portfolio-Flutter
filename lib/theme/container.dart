...
Widget container2 = SizedBox(
  ...
  child: Row(
    ...
    children: [
      Container(
        // col2ncr (39:636)
        margin: const EdgeInsets.fromLTRB(0 * fem, 0 * fem, 73 * fem, 0 * fem),
        width: 550 * fem,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Container(
// button9nA (39:860)
              margin: const EdgeInsets.fromLTRB(0 * fem, 0 * fem, 387 * fem, 0 * fem),
              child: TextButton(
                onPressed: () {},
                style: TextButton.styleFrom(
                  padding: EdgeInsets.zero,
                ...
                child: Container(
                  padding:
                      const EdgeInsets.fromLTRB(16 * fem, 8 * fem, 25 * fem, 8 * fem),
                  width: double.infinity,
                  decoration: BoxDecoration(
                    border: Border.all(color: const Color(0x8ce3e4e6)),
                    borderRadius: BorderRadius.circular(100 * fem),
